...
def _is_multihop_question(question: str) -> bool:
    ...
    lower = q.lower()
    # Skip obvious conversational / non-KG queries.
...
def main():
    ...
    with open(input_path, "r", encoding="utf-8") as fin, open(output_path, "w", encoding="utf-8") as fout:
        for line in fin:
            ...
            # If no effective decomposition, keep the original sample once.
            ...
            for i, sq in enumerate(subquestions):
                ...
                # Dependency-chain fields for cascade reasoning/poisoning.
